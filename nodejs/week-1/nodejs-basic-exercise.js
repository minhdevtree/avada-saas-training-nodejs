...
const usersWithPostAndCommentCounts = await getUsersWithPostAndCommentCounts();
console.log(
...
async function getUsersSortedByPostsCountDescending() {
  const users = await getUsersWithPostAndCommentCounts();
  return users.sort((a, b) => b.postsCount - a.postsCount);
}

const usersSortedByPostsCount = await getUsersSortedByPostsCountDescending();
console.log(
